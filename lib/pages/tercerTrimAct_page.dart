  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ValoracionesWidget(
          val: [
            Text('Ginecologia a la semana 32,\n si tiene antecedente de Cesarea',
...
class ListEcogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        height: queryData.size.height * 0.09, child: EcografiasWidget(
          ecografias: [
            Text('Ecografia Obstetrica\n semanas 32 - 34',
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: ParaclinicosWidget(
          ...
          paraclinicos: [
            Text('Hemograma'),
            Text('Cultivo para Estreptoco del grupo B, por hisopado recto-vaginal, a la semana 35 - 37, si es POSITIVO se debera administrar ampicilina durante el trabajo de parto',
            textAlign:TextAlign.justify),
            Text('VIH'),
